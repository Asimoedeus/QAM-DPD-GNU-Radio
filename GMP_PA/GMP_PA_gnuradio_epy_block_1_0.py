...
class blk(gr.sync_block):  # other base classes are basic_block, decim_block, interp_block
    ...
    def __init__(self, model_path='C:/Programming/pythonProjects/OpenDPD-main/save/GMP_PA/train_dpd/PA_S_0_M_DGRU_H_23_F_200/DPD_S_0_M_DGRU_H_15_F_200_P_1319.pt'):
