...
import GMP_PA_gnuradio_epy_block_1 as epy_block_1  # embedded python block
import GMP_PA_gnuradio_epy_block_1_0 as epy_block_1_0  # embedded python block
import sip
import threading



class GMP_PA_gnuradio(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "GMP_PA", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("GMP_PA")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "GMP_PA_gnuradio")
        ...
        self.epy_block_1_0 = epy_block_1_0.blk(model_path='C:/Programming/pythonProjects/OpenDPD-main/save/GMP_PA/train_dpd/PA_S_0_M_DGRU_H_23_F_200/DPD_S_0_M_DGRU_H_15_F_200_P_1319.pt')
        self.epy_block_1 = epy_block_1.PA_model_GMP(coeffs=[[0.95+0.01j, 0.05-0.02j],[0.00-0.00j, 0.00+0.00j],[-0.1-0.08j, -0.02-0.01j]])
        ...
        self.connect((self.epy_block_1, 0), (self.blocks_complex_to_mag_1, 0))
        self.connect((self.epy_block_1, 0), (self.blocks_throttle_0_0_0_0, 0))
        self.connect((self.epy_block_1_0, 0), (self.blocks_complex_to_mag_0, 0))
        self.connect((self.epy_block_1_0, 0), (self.epy_block_1, 0))
...
def main(top_block_cls=GMP_PA_gnuradio, options=None):
