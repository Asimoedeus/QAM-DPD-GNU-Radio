...
class default(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.epy_block_1_0 = epy_block_1_0.PA_model_GMP(coeffs=[[1.00+0.01j, 0.05-0.02j],[0.00-0.00j, 0.00+0.00j],[-0.1-0.08j, -0.02-0.01j]])
        self.epy_block_1 = epy_block_1.PA_model_GMP(coeffs=[[1.00+0.01j, 0.05-0.02j],[0.00-0.00j, 0.00+0.00j],[-0.1-0.08j, -0.02-0.01j]])
