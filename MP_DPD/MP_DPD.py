...
import MP_DPD_epy_block_0 as epy_block_0  # embedded python block
import MP_DPD_epy_block_1 as epy_block_1  # embedded python block
import sip
import threading



class MP_DPD(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "MP_DPD")
...
def main(top_block_cls=MP_DPD, options=None):
