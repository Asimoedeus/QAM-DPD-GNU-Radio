...
class default(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.epy_block_1_0 = epy_block_1_0.blk(model_path='C:/Programming/pythonProjects/QAM-In-GNU-Radio-main/ILA/dpd_model.pth', memory=3, order=3, order_memory=2, scale=1.0)
