...
class GMP_ILA_DPD(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "GMP_ILA_DPD")
        ...
        self.epy_block_1_0 = epy_block_1_0.blk(model_path='C:/Programming/pythonProjects/OpenDPD-main/save/GMP_PA/train_dpd/PA_S_0_M_DGRU_H_23_F_200/DPD_S_0_M_GMP_H_15_F_200_P_495.pt', memory=3, order=3, order_memory=2, scale=1.0)
        ...
        self.blocks_multiply_const_xx_0 = blocks.multiply_const_cc(1.5, 1)
...
def main(top_block_cls=GMP_ILA_DPD, options=None):
